        ...
        <Main>
          <CoursesAndMaterialsWrapper>
            <NewsletterWrapper data-aos="fade-left" data-aos-duration="1000">
              <h1>
                Registre-se em nossa Newsletter e fique por dentro de TUDO!
              </h1>
            ...
            <div>
              ...
              <Specialization>
                <ImageWrapper>
                  <img
                    src="/static/estudando.jpg"
                    alt="Especialização Estudando"
                  />
                  <h3>Matricule-se no mês que quiser!</h3>
                  <p>
                    Um sistema modulado para você iniciar o seu curso no mês que
                    você escolher!
                  </p>
                </ImageWrapper>
                <ImageWrapper>
                  ...
                  .map((course) => (
                    ...
                    >
                      ...
                      <CourseData>
                        ...
                        <h3 className="date">
                          Quando.:{" "}
                          <span className="date">{course.date_event}</span>
                        </h3>
                        <h3>
