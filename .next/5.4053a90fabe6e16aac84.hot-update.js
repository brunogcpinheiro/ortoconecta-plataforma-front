...
})(["background:transparent;color:#d6d6d6;h1{font-size:4em;margin-top:0;margin-bottom:0.5em;background:transparent;}h2{background:transparent;font-size:2em;}a{display:block;width:150px;background:", ";padding:1em;margin-top:50px;margin-left:auto;margin-right:auto;color:#fff;text-decoration:none;font-size:1.5em;transition:background 0.3s ease-in-out;&:hover{border:3px solid ", ";transition:background 0.3s ease-in-out;}}"], primaryColor, primaryColor);
...
//# sourceMappingURL=5.4053a90fabe6e16aac84.hot-update.js.map