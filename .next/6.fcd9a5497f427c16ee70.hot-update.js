...
})(["border:none;border:2px solid ", ";padding:16px 26px;background:#fff;color:#000;font-weight:bold;text-transform:uppercase;text-decoration:none;margin-top:24px;transition:background 0.3s;&:hover{background:", ";transition:background 0.3s;}"], primaryColor, primaryColor);
...
//# sourceMappingURL=6.fcd9a5497f427c16ee70.hot-update.js.map