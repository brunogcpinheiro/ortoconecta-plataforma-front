...
})(["background:transparent;color:#d6d6d6;h1{font-size:4em;margin-top:0;margin-bottom:0.5em;background:transparent;}h2{background:transparent;font-size:2em;}a{display:block;width:150px;padding:1em;margin-top:50px;margin-left:auto;margin-right:auto;color:#000;font-weight:bold;text-decoration:none;font-size:1.5em;background:", ";border:2px solid ", ";transition:background 0.3s ease-in-out;&:hover{background:transparent;color:#fff;transition:background 0.3s ease-in-out;}}"], primaryColor, primaryColor);
...
//# sourceMappingURL=5.44c2890fa5bfc00feca8.hot-update.js.map