...
})(["display:block;position:absolute;width:100vw;background-color:#f9f9f9;transform:scale(1);box-shadow:0px 8px 16px 0px rgba(0,0,0,0.2);padding:12px 16px;z-index:1;li{padding:16px;a{text-decoration:none;&:visited,&:active,&:link{color:inherit;}&:hover{color:", "}}}"], primaryColor);
...
//# sourceMappingURL=6.3a18b6bfbd8091a139e9.hot-update.js.map