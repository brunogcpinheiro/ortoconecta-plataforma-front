...
})(["display:flex;flex-direction:column;align-items:center;justify-content:center;background-image:url('/static/network.jpg');background-attachment:fixed;background-position:top center;background-size:cover;margin:5px auto;padding:16px;max-width:1366px;h2{font-size:3rem;text-align:center;}"]);
...
var Especialidades = function Especialidades(props) {
  ...
  }), " Entrevistas com especialistas"))), sorted.map(function (speciality) {
