...
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(8);
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(dayjs__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _layouts_main__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(7);
/* harmony import */ var react_icons_fa__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(3);
...
})(["max-width:1024px;height:100%;display:flex;flex-direction:column;justify-content:center;align-items:center;margin:50px auto;background:#fff;border:1px solid #ccc;border-radius:10px;-webkit-box-shadow:0px 3px 5px 0px rgba(184,184,184,1);-moz-box-shadow:0px 3px 5px 0px rgba(184,184,184,1);box-shadow:0px 3px 5px 0px rgba(184,184,184,1);h2,h3{background:#fff;}h2{font-size:1.3rem;padding:16px 0;color:#636e72;text-weight:bold;text-align:center;}h3{color:#7f8c8d;font-style:italic;}"]);
...
var StyledTextarea = styled_components__WEBPACK_IMPORTED_MODULE_2___default.a.div.withConfig({
  displayName: "especialidade__StyledTextarea",
  componentId: "sc-1oavti5-4"
})(["padding:20px;background:transparent;text-align:justify;border:none;width:100%;height:100%;p{font-size:1.2rem;padding:15px;}"]);
...
var Especialidade = function Especialidade(props) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_1__["Fragment"], null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(next_head__WEBPACK_IMPORTED_MODULE_4___default.a, null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("title", null, "OrtoConecta | ", props.speciality.title)), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_layouts_main__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"], null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(SpecialityWrapper, null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Title, null, title), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Img, {
    ...
    href: "http://api.ortoconecta.com.br".concat(material.url),
    target: "blank"
  ...
  }), " Baixar Material"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(StyledTextarea, null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("p", null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_markdown__WEBPACK_IMPORTED_MODULE_8___default.a, {
    source: article,
    style: {
      width: '100%'
    }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            query = _ref.query;
            _context.next = 3;
            return axios__WEBPACK_IMPORTED_MODULE_3___default.a.get("http://api.ortoconecta.com.br/specialities/".concat(query.id));
