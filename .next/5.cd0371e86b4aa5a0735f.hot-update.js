...
var Tips = function Tips(props) {
  console.log(props);
  var _props$tips = props.tips,
      title = _props$tips.title,
      publishedAt = _props$tips.publishedAt,
      material = _props$tips.material,
      description = _props$tips.description,
      tips_image = _props$tips.tips_image;
  return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react__["Fragment"], {
    ...
    src: "http://ortoconecta-plataforma-brunogcpinheiro.c9users.io:8080".concat(tips_image.url),
    alt: title,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 98
...
//# sourceMappingURL=5.cd0371e86b4aa5a0735f.hot-update.js.map