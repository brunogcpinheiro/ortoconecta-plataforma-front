...
})(["max-width:80%;height:100%;display:flex;justify-content:center;align-items:center;margin:50px auto;background:#fff;border:1px solid #ccc;border-radius:10px;-webkit-box-shadow:0px 3px 5px 0px rgba(184,184,184,1);-moz-box-shadow:0px 3px 5px 0px rgba(184,184,184,1);box-shadow:0px 3px 5px 0px rgba(184,184,184,1);div{display:flex;flex-direction:column;justify-content:center;align-items:center;margin:0;padding:0;}h2,h3{background:#fff;}h2{font-size:1.3rem;padding:16px 0;color:#636e72;text-weight:bold;}h3{color:#7f8c8d;font-style:italic;}"]);
...
var Tips = function Tips(props) {
  return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react__["Fragment"], {
    ...
    return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(TipsWrapper, {
      key: tip.id,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 103
...
//# sourceMappingURL=5.1762518b0a2071213615.hot-update.js.map