...
})(["display:flex;flex-direction:column;border:1px solid #ccc;border-radius:10px;padding:20px;-webkit-box-shadow:0px 3px 5px 0px rgba(184,184,184,1);-moz-box-shadow:0px 3px 5px 0px rgba(184,184,184,1);box-shadow:0px 3px 5px 0px rgba(184,184,184,1);form{display:flex;flex-direction:column;justify-content:flex-start;padding-top:16px;input{margin:10px;}textarea{margin-top:10px;}}"]);
...
//# sourceMappingURL=5.32a8de06fbdb5bcca8e7.hot-update.js.map