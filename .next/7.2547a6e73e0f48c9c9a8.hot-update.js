...
})(["display:block;position:absolute;width:100vw;background-color:#f9f9f9;transform:scale(1);box-shadow:0px 8px 16px 0px rgba(0,0,0,0.2);padding:12px 16px;z-index:1;li{padding:16px;border-bottom:1px solid #f5f5f5;a{text-decoration:none;font-size:1.2rem;&:visited,&:active,&:link{color:inherit;}&:hover{color:", "}}}"], primaryColor);
...
//# sourceMappingURL=7.2547a6e73e0f48c9c9a8.hot-update.js.map