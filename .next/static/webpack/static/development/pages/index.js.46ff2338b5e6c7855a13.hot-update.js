...
})(["height:80%;background:#fafafa;background-image:linear-gradient(rgba(0,0,0,0.75),rgba(0,0,0,0.75)),url('/static/background.jpg');", " ", " ", " ", " display:flex;align-items:center;justify-content:center;text-align:center;> div{margin:30px 0 100px 0;}"], ''
...
//# sourceMappingURL=index.js.46ff2338b5e6c7855a13.hot-update.js.map