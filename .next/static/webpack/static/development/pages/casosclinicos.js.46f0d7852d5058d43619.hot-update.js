...
})(["width:80%;height:100%;background:#fff;box-shadow:0 1px 1px rgba(0,0,0,0.15),0 10px 0 -5px #eee,0 10px 1px -4px rgba(0,0,0,0.15),0 20px 0 -10px #eee,0 20px 1px -9px rgba(0,0,0,0.15);padding:30px;margin:15px;display:flex;flex-direction:column;div{display:flex;img{width:200px;height:200px;}}"]);
...
//# sourceMappingURL=casosclinicos.js.46f0d7852d5058d43619.hot-update.js.map