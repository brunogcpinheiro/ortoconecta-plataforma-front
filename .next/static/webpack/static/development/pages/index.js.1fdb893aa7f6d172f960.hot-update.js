...
})(["width:90%;display:flex;justify-content:space-evenly;align-items:center;"]);
...
})(["display:flex;flex-direction:column;justify-content:space-around;align-items:center;width:25%;height:400px;background:#f5f5f5;text-align:justify;padding:16px;-webkit-box-shadow:0px 3px 5px 0px rgba(184,184,184,1);-moz-box-shadow:0px 3px 5px 0px rgba(184,184,184,1);box-shadow:0px 3px 5px 0px rgba(184,184,184,1);img{width:150px;height:150px;border-radius:50%;}"]);
...
//# sourceMappingURL=index.js.1fdb893aa7f6d172f960.hot-update.js.map