...
})(["height:80%;background:#fafafa;opacity:0.5;background-image:linear-gradient(rgba(0,0,0,0.55),rgba(0,0,0,0.55)),url('/static/background.jpg');", " ", " ", " ", " display:flex;align-items:center;justify-content:center;text-align:center;> div{margin:30px 0 100px 0;opacity:1;}"], ''
...
//# sourceMappingURL=index.js.f177a832fd33d14a051f.hot-update.js.map