...
})(["display:flex;flex-direction:column;align-items:center;justify-content:center;margin:50px auto;padding:16px;max-width:1366px;height:calc(100vh - 362px);h2{font-size:3rem;text-align:center;animation-name:flash;animation-duration:0.2s;animation-timing-function:linear;animation-iteration-count:infinite;animation-direction:alternate;animation-play-state:running;}@keyframes flash{from{color:red;}to{color:black;}}"]);
...
//# sourceMappingURL=aplicativo.js.f020456f06b5df0445c0.hot-update.js.map