...
})(["height:80%;background:#fafafa;background-image:linear-gradient(rgba(0,0,0,0.75),rgba(0,0,0,0.75)),url('/static/background.jpg');", " ", " ", " ", " display:flex;align-items:center;justify-content:center;text-align:center;> div{margin:30px 0 100px 0;-webkit-box-shadow:0px 3px 2px 0px rgba(94,94,94,1);-moz-box-shadow:0px 3px 2px 0px rgba(94,94,94,1);box-shadow:0px 3px 2px 0px rgba(94,94,94,1);}"], ''
...
//# sourceMappingURL=index.js.3724d65edadec541b08e.hot-update.js.map