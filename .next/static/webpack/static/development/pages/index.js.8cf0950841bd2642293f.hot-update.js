...
})(["width:100%;height:700px;background:", ";display:flex;flex-direction:column;justify-content:space-evenly;align-items:center;h1{font-size:2rem;}"], primaryColor);
...
})(["display:flex;flex-direction:column;justify-content:space-between;align-items:center;width:20%;height:500px;background:#f5f5f5;text-align:center;padding:16px;-webkit-box-shadow:0px 3px 5px 0px rgba(184,184,184,1);-moz-box-shadow:0px 3px 5px 0px rgba(184,184,184,1);box-shadow:0px 3px 5px 0px rgba(184,184,184,1);img{width:150px;height:150px;border-radius:50%;}"]);
...
//# sourceMappingURL=index.js.8cf0950841bd2642293f.hot-update.js.map