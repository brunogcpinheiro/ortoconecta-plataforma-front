...
})(["width:100%;height:700px;background:#fff;"]);
...
})(["width:250px;background:#fff;padding:30px;position:relative;box-shadow:1px 1px 1px rgba(0,0,0,0.25);border:1px solid #bbb;&::before,&::after{box-shadow:1px 1px 1px rgba(0,0,0,0.25);border:1px solid #bbb;}&::before,&::after{content:\"\";position:absolute;height:95%;width:99%;background-color:#eee;}&::before{right:15px;top:0;transform:rotate(-1deg);z-index:-1;}&::after{top:5px;right:-5px;transform:rotate(1deg);z-index:-2;}"]);
...
//# sourceMappingURL=index.js.87bbe47cef2dad7184ab.hot-update.js.map