...
})(["width:100%;height:100%;background:", ";display:flex;flex-direction:column;justify-content:space-evenly;align-items:center;margin-top:100px;h1{margin:20px 0;font-size:2rem;}"], primaryColor);
...
})(["width:100%;height:700px;background:#fff;div{width:0;height:0;border-top:50px solid transparent;border-left:100px solid ", ";border-bottom:50px solid transparent;transform:rotate(90deg) scale(5);margin-left:100px;}"], primaryColor);
...
//# sourceMappingURL=index.js.618389216ea91cbcf5f8.hot-update.js.map