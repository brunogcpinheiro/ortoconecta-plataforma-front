...
})(["height:80%;background:#fafafa;opacity:0.5;", " ", " ", " ", " ", " display:flex;align-items:center;justify-content:center;text-align:center;> div{margin:30px 0 100px 0;}"], ''
/* background-image: linear-gradient(rgba(0,0,0,0.55), rgba(0,0,0,0.55)), url('/static/background.jpg'); */
, ''
...
//# sourceMappingURL=index.js.811ea08c33908669c570.hot-update.js.map