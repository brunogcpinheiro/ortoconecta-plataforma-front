...
})(["width:70%;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;@media(max-width:1705px){width:80%;}@media(max-width:1475px){width:90%;}"]);
...
})(["display:flex;flex-direction:column;justify-content:space-around;align-items:center;width:300px;height:500px;background:#f5f5f5;text-align:justify;padding:16px;-webkit-box-shadow:0px 3px 5px 0px rgba(184,184,184,1);-moz-box-shadow:0px 3px 5px 0px rgba(184,184,184,1);box-shadow:0px 3px 5px 0px rgba(184,184,184,1);@media(max-width:1168px){height:550px;}img{width:150px;height:150px;border-radius:50%;}"]);
...
//# sourceMappingURL=index.js.75e53af39ac63dd2bd65.hot-update.js.map