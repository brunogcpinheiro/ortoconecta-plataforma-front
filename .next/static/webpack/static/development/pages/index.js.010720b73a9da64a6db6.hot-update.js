...
})(["height:80%;background:#fafafa;background-image:linear-gradient(rgba(0,0,0,0.15),rgba(0,0,0,0.15)),url('/static/background.jpg');", " ", " ", " ", " display:flex;align-items:center;justify-content:center;text-align:center;> div{margin:30px 0 100px 0;}"], ''
...
//# sourceMappingURL=index.js.010720b73a9da64a6db6.hot-update.js.map