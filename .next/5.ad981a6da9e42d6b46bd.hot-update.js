...
})(["display:flex;flex-direction:column;justify-content:space-evenly;flex-wrap:wrap;border:1px solid #ccc;border-radius:10px;padding:20px;-webkit-box-shadow:0px 3px 5px 0px rgba(184,184,184,1);-moz-box-shadow:0px 3px 5px 0px rgba(184,184,184,1);box-shadow:0px 3px 5px 0px rgba(184,184,184,1);transition:0.5s background;width:100%;div{h3{font-size:1.3rem;}h4{color:#999;}small{font-style:italic;font-size:0.8rem;}}"]);
...
//# sourceMappingURL=5.ad981a6da9e42d6b46bd.hot-update.js.map