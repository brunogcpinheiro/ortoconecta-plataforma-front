...
var Download = __WEBPACK_IMPORTED_MODULE_2_styled_components__["c" /* default */].button.withConfig({
  displayName: "especialidade__Download",
  componentId: "sc-1oavti5-4"
})(["display:block;width:150px;padding:1em;margin-top:50px;margin-left:auto;margin-right:auto;color:#000;font-weight:bold;text-decoration:none;font-size:1.1em;text-transform:uppercase;background:", ";border:2px solid ", ";transition:background 0.3s ease-in-out;-webkit-box-shadow:0px 3px 5px 0px rgba(94,94,94,1);-moz-box-shadow:0px 3px 5px 0px rgba(94,94,94,1);box-shadow:0px 3px 5px 0px rgba(94,94,94,1);"], primaryColor, primaryColor);
...
var Especialidade = function Especialidade(props) {
  ...
  }, __WEBPACK_IMPORTED_MODULE_7_react_icons_fa__["FaDownload"], " Baixar Material"), __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(Article, {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 113
    }
...
//# sourceMappingURL=6.92d5854564ac54e13caa.hot-update.js.map