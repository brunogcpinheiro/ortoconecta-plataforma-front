...
})(["margin:35px auto;width:70%;display:flex;justify-content:center;border:1px solid #ccc;border-radius:10px;padding:20px;-webkit-box-shadow:0px 3px 5px 0px rgba(184,184,184,1);-moz-box-shadow:0px 3px 5px 0px rgba(184,184,184,1);box-shadow:0px 3px 5px 0px rgba(184,184,184,1);transition:0.5s background;div:first-child{flex:2;height:100%;}div:last-child{flex:1;margin-left:15px;h1{margin-bottom:16px;text-align:center;}p{text-align:justify;}}@media (max-width:980px){display:flex;flex-direction:column;align-items:center;}"]);
...
//# sourceMappingURL=5.f50cdf7dd39382247165.hot-update.js.map