...
})(["display:flex;align-items:center;justify-content:center;flex-direction:column;max-width:860px;margin:20px auto;h1{font-size:5rem;color:", ";font-weight:bold;}p{margin-top:16px;text-align:justify;font-size:1.5rem;color:#636e72;span{margin-left:24px;font-size:1.5rem;}}h3{font-size:1.7rem;margin-top:16px;}"], primaryColor);
...
var Home = function Home(props) {
  ...
  }, "Bem-vindos \xE0 plataforma Orto Conecta!"))));
};
...
//# sourceMappingURL=5.b0538ee5c6398667420f.hot-update.js.map