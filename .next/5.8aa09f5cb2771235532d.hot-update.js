...
})(["display:flex;flex-direction:column;justify-content:flex-start;border:1px solid #ccc;border-radius:10px;padding:20px;-webkit-box-shadow:0px 3px 5px 0px rgba(184,184,184,1);-moz-box-shadow:0px 3px 5px 0px rgba(184,184,184,1);box-shadow:0px 3px 5px 0px rgba(184,184,184,1);form{display:flex;flex-direction:column;justify-content:flex-start;padding:16px;input{margin:10px;}textarea{margin-top:10px;}}"]);
...
//# sourceMappingURL=5.8aa09f5cb2771235532d.hot-update.js.map