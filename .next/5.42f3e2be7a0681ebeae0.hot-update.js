...
})(["display:flex;align-items:center;justify-content:center;flex-direction:column;width:80%;max-width:860px;margin:-50px auto;border:1px solid #ccc;padding:26px;border-radius:10px;-webkit-box-shadow:0px 1px 1px 1px #f5f5f5;-moz-box-shadow:0px 1px 1px 1px #f5f5f5;box-shadow:0px 1px 1px 1px #f5f5f5;h1{font-size:3rem;color:#f1c40f;font-weight:bold;}img{width:80%;height:450px;margin-top:16px;border-radius:15px;border:2px solid ", "}p{margin-top:16px;text-align:justify;font-size:1.2rem;color:#2d3436;strong{font-size:1.2rem;color:#181818;}span{margin-left:24px;font-size:1.2rem;}}h3{font-size:2rem;margin-top:24px;color:#2d3436;text-align:center;span{margin-top:16px;font-size:2rem;color:#f1c40f;font-weight:bold;}}"], primaryColor);
...
//# sourceMappingURL=5.42f3e2be7a0681ebeae0.hot-update.js.map